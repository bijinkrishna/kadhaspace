...
export default function NewRecipePage() {
  ...
  const updateIngredient = (index: number, field: string, value: string) => {
    ...
    // Check for duplicate when ingredient is selected
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Add ingredients and calculate COGS</p>
          </div>
          <button
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500"
                  placeholder="e.g., 1 plate, 1 glass"
                />
              </div>
            ...
            {recipeIngredients.length === 0 ? (
              ...
              <div className="space-y-3">
                {recipeIngredients.map((ri, index) => {
                  ...
                  // Get available ingredients for this row
                      ...
                      <div className="flex-1 grid grid-cols-12 gap-3">
                        ...
                        <div className="col-span-4">
                          ...
                          >
                            ...
                            {/* Show currently selected ingredient even if used elsewhere */}
